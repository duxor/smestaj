...
<div class="row">
    <div class="col-sm-4">
        ...
        @foreach($podaci['aplikacije'] as $aplikacija)
            <p>{{$aplikacija['naziv']}} <a href="{!!url('/modercija/podesavanja/'.$aplikacija['slug'])!!}" target="_blank" class="btn btn-info glyphicon glyphicon-pencil"></a> <a href="/{{$aplikacija['slug']}}" target="_blank" class="btn btn-default glyphicon glyphicon-eye-open"></a></p>
        @endforeach
    </div>
</div>
<div class="row">
